...
class ResNet18Encoder(nn.Module):
    def __init__(self, freeze=True):
        ...
        resnet18_model.conv1 = nn.Conv2d(3, 64, kernel_size=7, stride=1, padding=3, bias=False)
        resnet18_model.maxpool = nn.Identity()  # Remove initial maxpool
...
class SharpUNetResNet18(nn.Module):
    def __init__(self, n_classes=1, freeze=True):
        super(SharpUNetResNet18, self).__init__()
