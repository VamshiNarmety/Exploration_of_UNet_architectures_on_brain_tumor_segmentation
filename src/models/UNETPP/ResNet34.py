...
# Encoder using pretrained ResNet34
...
# Convolutional block for the decoder
...
# UNet++ architecture with ResNet34 as encoder
class UNetPlusPlusResNet34(nn.Module):
    def __init__(self, in_channels=3, out_channels=1, freeze=True):
        ...
        self.conv3_0 = ConvBlock(256, 128)
        self.conv2_0 = ConvBlock(128, 64)
        self.conv1_0 = ConvBlock(64, 32)

        self.conv3_1 = ConvBlock(256 + 128, 128)
        self.conv2_1 = ConvBlock(128 + 64, 64)
        self.conv1_1 = ConvBlock(64 + 32, 32)

        self.conv2_2 = ConvBlock(128 + 64, 64)
        self.conv1_2 = ConvBlock(64 + 32, 32)

        self.conv1_3 = ConvBlock(64 + 32, 32)
